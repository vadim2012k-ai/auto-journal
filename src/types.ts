...
export interface Car {
  ...
  tankCapacity?: number;
  /**
   * Свои интервалы ТО (км) для этой машины — переопределяют стандартные
   * значения из config.ts там, где заданы. Остальные категории продолжают
   * использовать значение по умолчанию.
   */
  customIntervals?: Partial<Record<CategoryId, number>>;
}
